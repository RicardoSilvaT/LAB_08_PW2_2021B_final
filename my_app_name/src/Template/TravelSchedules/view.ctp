...
<body>
    ...
    <nav class="large-3 medium-4 columns" id="actions-sidebar">
        <ul class="side-nav">
            ...
            <li><?= $this->Html->link(__('Edit Travel Schedule'), ['action' => 'edit', $travelSchedule->TravelSchedules_Code]) ?> </li>
            <li><?= $this->Form->postLink(__('Delete Travel Schedule'), ['action' => 'delete', $travelSchedule->TravelSchedules_Code], ['confirm' => __('Are you sure you want to delete # {0}?', $travelSchedule->TravelSchedules_Code)]) ?> </li>
            <li><?= $this->Html->link(__('List Travel Schedules'), ['action' => 'index']) ?> </li>
            <li><?= $this->Html->link(__('New Travel Schedule'), ['action' => 'add']) ?> </li>
        </ul>
    </nav>
    <div class="travelSchedules view large-9 medium-8 columns content">
        <h3><?= h($travelSchedule->TravelSchedules_Code) ?></h3>
        <table class="vertical-table">
            <tr>
                <th scope="row"><?= __('TravelSchedules Code') ?></th>
                <td><?= $this->Number->format($travelSchedule->TravelSchedules_Code) ?></td>
            </tr>
            <tr>
                <th scope="row"><?= __('Travel Schedules Transport Code') ?></th>
                <td><?= $this->Number->format($travelSchedule->Travel_Schedules_Transport_Code) ?></td>
            </tr>
            <tr>
                <th scope="row"><?= __('Travel Schedules Code Route') ?></th>
                <td><?= $this->Number->format($travelSchedule->Travel_Schedules_Code_Route) ?></td>
            </tr>
            <tr>
                <th scope="row"><?= __('Travel Schedules Date') ?></th>
                <td><?= h($travelSchedule->Travel_Schedules_Date) ?></td>
            </tr>
            <tr>
                <th scope="row"><?= __('Travel Schedules Hour') ?></th>
                <td><?= h($travelSchedule->Travel_Schedules_Hour) ?></td>
            </tr>
            <tr>
                <th scope="row"><?= __('Travel Schedules Registration Status') ?></th>
                <td><?= $travelSchedule->Travel_Schedules_Registration_Status ? __('Yes') : __('No'); ?></td>
            </tr>
        </table>
    </div>
