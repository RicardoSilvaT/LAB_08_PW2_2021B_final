        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="single-package-item">
                    ...
                    <div class="single-package-item-txt">
                        <h3>Tickets <span class="pull-right"></span></h3>
                        <!--/.packages-para-->

                        <!--/.packages-review-->
                        <div class="about-btn">
                            <?php echo $this->Form->button('Admin', array(
                                'type' => 'button',
                                'class' => 'book-btn',
                                'onclick' => 'location.href=\'/travel-schedules/\';',
                            )); ?>
                        </div>
                        <!--/.about-btn-->
                    </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="single-package-item">
                    ...
                    <div class="single-package-item-txt">
                        <h3>Vehicles <span class="pull-right" onclick="location.href='http://localhost/';"></span></h3>
                        <!--/.packages-para-->
                        <!--/.packages-review-->
                        <div class="about-btn">
                            <?php echo $this->Form->button('Admin', array(
            ...
            <div class="col-md-4 col-sm-6">
                <div class="single-package-item">
                    ...
                    <div class="single-package-item-txt">
                        <h3>User <span class="pull-right"></span></h3>
                        <!--/.packages-review-->
                        <div class="about-btn">
                            <?php echo $this->Form->button('Admin', array(
                                'type' => 'button',
            ...
            <div class="col-md-4 col-sm-6">
                <div class="single-package-item">
                    ...
                    <div class="single-package-item-txt">
                        <h3>TravelSchedules <span class="pull-right"></span></h3>
                        <!--/.packages-review-->
                        <div class="about-btn">
                            <?php echo $this->Form->button('Admin', array(
                                'type' => 'button',
            ...
            <div class="col-md-4 col-sm-6">
                <div class="single-package-item">
                    ...
                    <div class="single-package-item-txt">
                        <h3>Companies <span class="pull-right"></span></h3>
                        <!--/.packages-review-->
                        <div class="about-btn">
                            <?php echo $this->Form->button('Admin', array(
                                'type' => 'button',
            ...
            <div class="col-md-4 col-sm-6">
                <div class="single-package-item">
                    ...
                    <div class="single-package-item-txt">
                        <h3>Drivers <span class="pull-right"></span></h3>
                        <!--/.packages-review-->
                        <div class="about-btn">
                            <?php echo $this->Form->button('Admin', array(
                                'type' => 'button',
            ...
            <div class="col-md-4 col-sm-6">
                <div class="single-package-item">
                    <!-- <img src="assets/images/packages/p6.jpg" alt="package-place"> -->
                    <div class="single-package-item-txt">
                        <h3>Agencies <span class="pull-right"></span></h3>
                        <!--/.packages-review-->
                        <div class="about-btn">
                            <?php echo $this->Form->button('Admin', array(
                                'type' => 'button',
            ...
            <div class="col-md-4 col-sm-6">
                <div class="single-package-item">
                    <!-- <img src="assets/images/packages/p6.jpg" alt="package-place"> -->
                    <div class="single-package-item-txt">
                        <h3>Routes <span class="pull-right"></span></h3>
                        <!--/.packages-review-->
                        <div class="about-btn">
                            <?php echo $this->Form->button('Admin', array(
                                'type' => 'button',
