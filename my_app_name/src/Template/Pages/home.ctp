												...
												<div class="single-tab-select-box">
													...
													<div class="travel-select-icon">
														<select class="form-control ">
															...
															<option value="turkey">Cusco</option><!-- /.option-->

															<option value="russia">Arequipa</option><!-- /.option-->
															<option value="egept">Lima</option><!-- /.option-->
													...
													<div class="travel-select-icon">
														<select class="form-control ">
															...
															<option value="istambul">Arequipa</option><!-- /.option-->

															<option value="mosko">Cusco</option><!-- /.option-->
															<option value="cairo">Lima</option><!-- /.option-->
	...
	<section id="pack" class="packages">
		<div class="container">
			<div class="gallary-header text-center">
				...
				<p>
					Vea los destinos mas visitados y sus facilidades.
				</p>
			</div>
			<!--/.gallery-header-->
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-6">
						<div class="single-package-item">
							<img src="https://elcomercio.pe/resizer/Yv2dSGYKyCfh6ZsOOXKt9MYOxD0=/580x330/smart/filters:format(jpeg):quality(75)/arc-anglerfish-arc2-prod-elcomercio.s3.amazonaws.com/public/6AG34MFW65FL5DNLJ2AHK363FY.jpg" alt="package-place">
							<div class="single-package-item-txt">
								<h3>Arequipa <span class="pull-right">S/30</span></h3>
								<div class="packages-para">
									<p>
										<span>
											<i class="fa fa-angle-right"></i> 3 Horas de viaje
										</span>
									...
									<p>
										...
										<i class="fa fa-angle-right"></i> Facilidad de transporte de mascotas
									</p>
								</div>
								<!--/.packages-para-->
					...
					<div class="col-md-4 col-sm-6">
						<div class="single-package-item">
							<img src="https://pymstatic.com/94582/conversions/psicologos-tacna-default.jpg" alt="package-place">
							<div class="single-package-item-txt">
								<h3>Tacna <span class="pull-right">S/60</span></h3>
								<div class="packages-para">
									<p>
										<span>
											<i class="fa fa-angle-right"></i> 6 Horas de viaje
										</span>
										<i class="fa fa-angle-right"></i> servicio 5 estrellas
									</p>
									<p>
					...
					<div class="col-md-4 col-sm-6">
						<div class="single-package-item">
							<img src="https://cdn.getyourguide.com/img/location/54b40793cd6af.jpeg/88.jpg" alt="package-place">
							<div class="single-package-item-txt">
								<h3>Lima <span class="pull-right">S/100</span></h3>
								<div class="packages-para">
									<p>
										<span>
											<i class="fa fa-angle-right"></i> 1 dia de viaje
										</span>
										<i class="fa fa-angle-right"></i> Servicio 5 estrellas
									</p>
									<p>
					...
					<div class="col-md-4 col-sm-6">
						<div class="single-package-item">
							<img src="https://www.pasosdeviajero.com/viajes-familiares/cusco/images/fulls/machu-picchu.jpg" alt="package-place">
							<div class="single-package-item-txt">
								<h3>Cusco <span class="pull-right">S/80</span></h3>
								<div class="packages-para">
									<p>
										<span>
											<i class="fa fa-angle-right"></i> 12 horas de viaje
										</span>
										<i class="fa fa-angle-right"></i> servicio 5 estrellas
									</p>
									<p>
					...
					<div class="col-md-4 col-sm-6">
						<div class="single-package-item">
							<img src="https://www.peru.travel/Contenido/Destino/Imagen/pe/37/1.3/Principal/Los%20Uros.jpg" alt="package-place">
							<div class="single-package-item-txt">
								<h3>Puno <span class="pull-right">S/50</span></h3>
								<div class="packages-para">
									<p>
										<span>
											<i class="fa fa-angle-right"></i> 6 horas de viaje
					...
					<div class="col-md-4 col-sm-6">
						<div class="single-package-item">
							...
							<div class="single-package-item-txt">
								<h3>Ica <span class="pull-right">S/40</span></h3>
								<div class="packages-para">
									<p>
										<span>
								...
								<!--/.packages-review-->
								<div class="about-btn">
									<?php echo $this->Form->button('Buy now', array(
									'type' => 'button',
									'class' => 'book-btn',
									'onclick' => 'location.href=\'/tickets/checkout/\';',
									)); ?>
								</div>
								<!--/.about-btn-->
							</div>
